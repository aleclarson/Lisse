...
Smooth-corner SVG primitives for React, Vue, and Svelte, plus an unofficial Octane adapter.
...
Lisse implements [Figma's corner smoothing algorithm](https://www.figma.com/blog/desperately-seeking-squircles/) and three other corner curves in JavaScript. It generates SVG paths and CSS `clip-path` values, with first-class bindings for React, Vue, and Svelte. An unofficial Octane adapter is available as `lisse-octane`.
...
For Vue, Svelte, the unofficial Octane adapter, or framework-agnostic core, see the [packages](#packages) below.
...
| `lisse-octane` | [![npm](https://img.shields.io/npm/v/lisse-octane?label=)](https://www.npmjs.com/package/lisse-octane) | Unofficial Octane adapter |
